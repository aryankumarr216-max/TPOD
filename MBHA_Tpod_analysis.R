...
twenty_gene_MBHA_Tpod <- as.numeric(twenty_gene_MBHA_table[2])
##################################################################
...
tenth_percentile_MBHA_Tpod <- as.numeric(tenth_percentile_MBHA_table[2])
...
ggplot(df, aes(x = logBestBMD)) +
  ...
  geom_vline(xintercept = log10(LCRD2_MBHA_Tpod),
             linetype = "dashed",
             color = "blue") +
  
  geom_vline(xintercept = log10(First_mode_MBHA_Tpod),
             linetype = "dashed",
             color = "green") +
  
  geom_vline(xintercept = log10(twenty_gene_MBHA_Tpod),
             linetype = "dashed",
             color = "purple") +
  
  geom_vline(xintercept = log10(MBHA_Cat_tpod),
             linetype = "dashed",
             color = "pink") +
...
tpod_df <- data.frame(
  ...
  label = c(
    ...
    paste0("LCRD = ", round((LCRD2_MBHA_Tpod), 3)),
    paste0("First Mode = ", round((First_mode_MBHA_Tpod), 3)),
    paste0("20th Gene = ", round((twenty_gene_MBHA_Tpod), 3)),
    paste0("Category = ", round((MBHA_Cat_tpod), 3))
  )
)
