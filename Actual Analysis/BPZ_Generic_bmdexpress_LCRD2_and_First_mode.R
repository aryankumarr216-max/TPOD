...
df <- read_excel("BPZ_Generic_bmdexpress_input_log2_transformed_1_williams_0.05_NOMTC_foldfilter1.5_BMD_filtered.xlsx", skip = 53)
...
file.copy(
  from = "BPZ_Generic_bmdexpress_LCRD2_and_First_mode.R",
  to = "C:/Users/KumarA/Downloads/R_Stuff/Actual Analysis/FINAL_tpod/Generic/current_script.R"
)
